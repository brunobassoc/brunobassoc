<!-- Header -->
<p align="center">
  <img src="https://i.giphy.com/media/v1.Y2lkPTc5MGI3NjExN2c2M3FjenJra25ja2xjMDhlcDZrZmdmdjE3OHRhcjE1Y2J5NDZvZyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/fHRP7nAicEggw/giphy.gif" width="260" alt="Baymax waving" />
</p>
...
- Interested in **data modeling, APIs, performance & automation**  
...
- [🧠 **CharRNN-TextGenerator**](https://github.com/brunobassoc/CharRNN-TextGenerator)  
  Recurrent Neural Network for character-level text generation using Python.  
  Demonstrates understanding of neural architectures and sequential data modeling.  
...
- [🧭 **A* Pathfinding — Streamlit**](https://github.com/brunobassoc/a-star-pathfinding-streamlit)  
  ...
  Focused on algorithm logic, heuristic functions, and interactive visual feedback.  
  ![Python](https://img.shields.io/badge/-Python-3776AB?style=flat&logo=python&logoColor=white)
  ![Streamlit](https://img.shields.io/badge/-Streamlit-FF4B4B?style=flat&logo=streamlit&logoColor=white)

- [⚙️ **AnalizadorClojure**](https://github.com/brunobassoc/AnalizadorClojure)  
  Lexical analyzer written in Python for a Clojure-like syntax.  
  Highlights computational thinking, parsing, and the fundamentals of compiler design.  
  ![Python](https://img.shields.io/badge/-Python-3776AB?style=flat&logo=python&logoColor=white)
